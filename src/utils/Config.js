...
export const SampleGattAttributes = {
  ...
  SIMPLEIO_CHAR4_CHARACTERISTIC: '0000fff4-0000-1000-8000-00805f9b34fb'.toUpperCase(), // 
  SIMPLEIO_CHAR5_CHARACTERISTIC: '0000fff5-0000-1000-8000-00805f9b34fb'.toUpperCase(), // 修改密码服务
